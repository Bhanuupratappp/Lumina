            ...
            <nav>
                <div className='wrapper'>
                    ...
                    <ul className='navlinks'>
                        <li><a style={{ fontSize: "40px", fontWeight: "700", color: "#fc2779" }} onClick={()=>navigate('/')} className='logo' href="#">Lumina</a></li>
                    ...
                    <div className='inputSection'>
                        <div className='searchDiv'>
                            ...
                            <input onKeyDown={handleKeyDown}  onChange={handleInputChange} className='search' placeholder='Search on Lumina' type="text" />
...
const DIV = styled.div`
  ...
  .upperNav{
    ...
    height: 40px;
    background-image: linear-gradient(to right, #9ed7c4 , #e0e6b3,#9ed7c4, #e0e6b3);
    position: sticky;
    top: 0;
    left: 0;
    z-index: 100;
