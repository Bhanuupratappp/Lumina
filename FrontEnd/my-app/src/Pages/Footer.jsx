  ...
  return (
    <DIV>
        <div className='footer1'>
           ...
           <div>
            <p><i class='bx bx-mobile-alt'></i>EXPERIENCE THE LUMINA MOBILE APP</p>
            <img src={play} alt="" />
        ...
        <div className='footer2'>
            <div>
            <h3 style={{fontSize:"40px",fontWeight:"700",color:"white",marginTop:"-23px",marginBottom:"10px"}} className='logo' >Lumina</h3>
                <p>Who are we?</p>
                <p>Careers</p>
                <p>Authenticity</p>
                <p>Press</p>
          ...
          <div className='footer3'>
            ...
            <br />
            <p>© 2023 Lumina E-Retail Pvt. Ltd. All Rights Reserved.</p>
          </div>
