...
export const OrderConfirmation = () => {
  ...
  return (
    <DIV>
        <Navbar />
        <div className='order'>
        <h2>Lumina will never contact you to offer products, cash or free prizes, etc. Please do not respond, make payment or share your personal information like CVV, PIN or passwords via a call, WhatsApp or other links</h2>
